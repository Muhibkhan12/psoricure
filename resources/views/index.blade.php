...
<body>
    ...
    <video autoplay loop muted playsinline
        ...
        <source src="{{ asset('videos/product.mp4') }}" type="video/mp4">

    </video>

    <div style="position:absolute;bottom:2rem;left:50%;transform:translateX(-50%);display:flex;gap:8px;z-index:2;">
